...
function updateSummary() {
  ...
  document.getElementById('pto-remaining-hours').textContent = Math.round((state.available.pto.hours - ptoUsedHours) * 100) / 100;
  ...
  document.getElementById('sick-remaining-hours').textContent = Math.round((state.available.sick.hours - sickUsedHours) * 100) / 100;
